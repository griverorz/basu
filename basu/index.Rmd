...
<p>Leave empty the box that you want to calculate.</p>

```{r}
tags$div(class="form-group",
         tags$label("First proportion"),
         tags$input(class="form-control",
                    placeholder="First proportion (e.g., 0.8)",
...
tags$div(class="form-group",
         ...
         tags$input(class="form-control",
                    placeholder="First proportion (e.g., 0.2)",
                    type="number", min="0", max="1", step="0.001",
                    id="p2"))
...
tags$div(class="form-group",
         ...
         tags$select("form-control",
                     ...
                     tags$option("First proportion smaller than second", value="less"),
                     tags$option("First proportion greater than second", value="greater"),
                     id="alternative"))
